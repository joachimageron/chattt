  ...
  devtools(
    subscribeWithSelector(
      ...
      (set, get) => ({
        ...
        // Typing actions (not persisted - cleared on reload)
      ...
      }),
      {
        ...
        partialize: (state) => ({
          ...
          messageToConversation: state.messageToConversation,
          // Don't persist typing (temporary state)
        }),
        // Version for migration purposes
        version: 1,
        // Optional: migrate function for future schema changes
